...
export class EditProfileComponent implements OnInit {
    ...
    constructor(
        ...
        private _uiService: UIService, private route: ActivatedRoute,
        ...
        this.userformRegister = fb.group({
            'email': [this.newUser.email, Validators.compose([Validators.required, Validators.email])],
            'firstName': [this.newUser.firstName, Validators.compose([Validators.required])],
            'lastName': [this.newUser.lastName, Validators.compose([Validators.required])],
        });
        this.userformRegister.get('email').disable();
    }
    ...
    loadUser() {
        ...
        this._userService.getUserByIdNew(this.user.id).subscribe(
            (res) => {
    ...
    onSubmit() {
        ...
        if (this.newUser.id && this.newUser.id != null) {
            if (this.formRegister.valid) {
                ...
                this.utilityService.validateAllFormFields(this.formRegister);
            }
        }
        else {
    ...
    onLawyerSubmit() {
        console.log("test", this.userformRegister);
    ...
    docUploaded(data) {
        ...
        let docs = null;
        docs = data.docs;
        this.newUser.resume = this.userForm.resume = docs;
